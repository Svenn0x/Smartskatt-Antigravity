        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          <nav className="hidden sm:flex items-center gap-6">
            <div className="relative group">
              <button className="text-sm font-medium text-slate-600 group-hover:text-secondary transition-colors flex items-center gap-1 cursor-default py-2">
                Skatteguider
            ...
            <Link href="/kalkulator" className="text-sm font-medium text-slate-600 hover:text-secondary transition-colors flex items-center gap-1 py-2 active:scale-95">
              Kalkulator
          ...
          <div className="hidden sm:flex items-center">
            <Link href="/veiviser" className="text-sm font-semibold bg-brand-gradient text-white px-5 py-2.5 rounded-full transition-all hover:shadow-md hover:scale-105 active:scale-95">
              Skatteveiviser
            </Link>
          </div>
          ...
          {/* Mobile Menu Button */}
          <button 
            className="sm:hidden p-2 text-slate-600 hover:text-slate-900 focus:outline-none focus:ring-2 focus:ring-secondary rounded-lg active:scale-95 transition-transform"
        ...
        {isMobileMenuOpen && (
          <div className="sm:hidden border-t border-slate-100 bg-white shadow-lg animate-in slide-in-from-top-2 duration-200">
            <div className="px-4 pt-2 pb-6 space-y-1">
              ...
              <Link href="/fradrag" onClick={() => setIsMobileMenuOpen(false)} className="block px-3 py-2.5 rounded-xl text-base font-medium text-slate-700 hover:bg-slate-50 hover:text-secondary active:bg-slate-100">
                Fradrag A-Å
              </Link>
              <Link href="/kalkulator" onClick={() => setIsMobileMenuOpen(false)} className="block px-3 py-2.5 rounded-xl text-base font-medium text-slate-700 hover:bg-slate-50 hover:text-secondary active:bg-slate-100 flex items-center gap-2">
                Kalkulator
                <span className="flex h-1.5 w-1.5 rounded-full bg-emerald-500"></span>
              </Link>
            </div>
